    ...
    return (
        <div name='contact' className=' w-full h-screen bg-gray-900 flex justify-center items-center p-4'>
            <form method='POST' action='https://getform.io/f/0f62fa35-34fd-4175-a8b9-b8ec2c5b1800' className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-[#4285F4] text-white'>Contact</p>
                    <p className='text-gray-500 text-2xl py-4'>Submit the form below or shoot me an email - tcolson10@gmail.com</p>
                </div>
                ...
                <button className='text-white border-2 hover:bg-[#DB4437] hover:border-[#DB4437] px-10 py-3 my-8 mx-auto flex items-center'>Send</button>
            </form>
        </div>
    )
}
