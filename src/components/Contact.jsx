    ...
    return (
        <div name='contact' className=' w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
            <form method='POST' action='https://getform.io/f/0f62fa35-34fd-4175-a8b9-b8ec2c5b1800' className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-green-400 text-gray-300'>Contact</p>
                ...
                <button className='text-white border-2 hover:bg-green-400 hover:border-green-400 px-10 py-3 my-8 mx-auto flex items-center'>Send</button>
            </form>
        </div>
    )
}
