...
// //         <h2 className='text-4xl sm:text-4xl font-bold text-gray-500'>I'm a Full-Time Student and Software Engineer.</h2>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <div>
          <Link to="skills" smooth={true} duration={500}>
            <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#DB4437] hover:border-[#DB4437]'>
              View Skills
              <span className='group-hover:rotate-90 duration-300'>
                <HiArrowNarrowRight className='ml-3' />
              </span>
